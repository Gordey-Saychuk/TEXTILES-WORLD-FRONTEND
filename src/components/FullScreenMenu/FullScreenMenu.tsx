			...
			<div className={styles.content}>
				{selectedCategory === 'shades' ? (
					<ul className={styles.list}>
						<Link href="/catalog/shtori">
							{' '}
							<li className={styles.lists}>КАТАЛОГ</li>
						</Link>
						<Link href="/catalog/tyul">
							<li className={styles.lists}>ТЮЛЬ</li>{' '}
						</Link>
					</ul>
				) : (
					<ul className={styles.list}>
						<Link href="/catalog/postelnoe-belie">
							<li className={styles.lists}>КАТАЛОГ</li>
						</Link>
						<Link href="/catalog/pledy">
							{' '}
							<li className={styles.lists}>ПЛЕДЫ</li>
						</Link>
						<Link href="/catalog/prostynya">
							<li className={styles.lists}>ПРОСТЫНЯ</li>
						</Link>
						<Link href="/catalog/nabor-postelnogo-belya">
							{' '}
							<li className={styles.lists}>НАБОРЫ ПОСТЕЛЬНОГО</li>
						</Link>
					</ul>
				)}
			</div>
